...
% 3. Raccolta dei dati
% 4. Valutazione della qualità del dato
...
\begin{description}
  ...
  \emph{Luz}, dalle emersioni del corpus, si pone in continuità con il Contemporaneo
  in quanto ancora oggi illumina dal fascio di tenebre da cui è forgiata.
  Cardine tra le esplorazioni è il \emph{Timbro}, che viene articolato in 24
  differenti tipologie.
  L'Opera in oggetto di Domenico Guaccero ha dato impulso al percorso di ricerca.
  Dal gennaio del 2023 è stata ascoltata in quattro interpretazioni in concerto,
  mediante le quali il percorso di ricerca si è nutrito.
...
Il clarinetto contrabbasso, luogo-strumento periferico:
Che cos'è uno strumento? Percorso di approfondimento con Giorgio Netti.
...
%  Gli studenti svilupperanno progetti di ricerca innovativi che coniughino creatività artistica e rigore acca- demico, contribuendo allo sviluppo della musica e delle discipline correlate.
...
% Allo scopo di favorire la creazione di un ambiente di ricerca dinamico e collaborativo, le attivi- tà didattiche, formative e artistiche sono organizzate in un unico curriculum ma avranno luo- go nelle quattro città sedi dei Conservatori promotori (Ferrara, Pescara, Trieste, Udine)
