...
\begin{description}
  ...
  \item[Tesi di Dottorato] Autocostruzione di un Interprete potrà essere il
    ...
    raffinamento di processi didattici derivanti dal metodo di ricerca;
  ...
  \item[Concerto] Il concerto finale del percorso vuole collegare in un arco di
    ascolto il percorso di ricerca e il percorso mentale attorno al concetto di
    esplorazione timbrica dello strumento clarinetto: \emph{Luz}, per strumento
    grave e silenzio animato; Brano originale per clarinetto contrabbasso ed
    elettronica; brano originale per clarinetto contrabbasso aumentato e timpano
    elettromagnetico.
\end{description}
